...
layout: quickstart
short: Web
description: This guide gets you started with HRPC-Web with a simple working example.
---
...
In this demo, there are three key components:
 ...
 1. `node-server`: This is a standard HRPC Server, implemented in Node.
 ...
 browser's HRPC-Web requests to port `:9090`. This is done via a config file
 `envoy.yaml`.
 ...
 interacts with the webpage, it sends a HRPC-Web request to the Envoy proxy
 endpoint at `:8080`.


### What's next

- Work through a more detailed tutorial in [HRPC Basics: Web](/docs/tutorials/basic/web/)
